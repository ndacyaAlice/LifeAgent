...
const RecordCard = ({ record, onNavigate }) => {
  return (
    <div className="flex flex-col rounded-xl border bg-[#1c1c24] shadow-sm dark:border-neutral-800 dark:bg-[#13131a]">
      ...
      <a
        onClick={() => onNavigate(record.RecordId)}
        className="inline-flex cursor-pointer items-center justify-between rounded-b-xl border-t border-gray-200 px-4 py-3 text-sm text-gray-100 hover:bg-gray-700 md:px-5 dark:border-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-800"
      >
        {record.RecordName}
        <IconChevronRight />
      </a>
